...
public class StoreResourceIntTest {
     ...
     *
     * @see io.github.jhipster.application.repository.search.StoreSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void setup() {
        ...
        final StoreResource storeResource = new StoreResource(storeRepository, mockStoreSearchRepository);
