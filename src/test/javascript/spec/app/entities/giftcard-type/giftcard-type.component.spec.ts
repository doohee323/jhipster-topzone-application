...
import { GiftcardTypeComponent } from 'app/entities/giftcard-type/giftcard-type.component';
...
describe('Component Tests', () => {
    describe('GiftcardType Management Component', () => {
        let comp: GiftcardTypeComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(GiftcardTypeComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.giftcardTypes[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
