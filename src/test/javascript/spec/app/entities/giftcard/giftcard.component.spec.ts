...
import { GiftcardComponent } from 'app/entities/giftcard/giftcard.component';
...
describe('Component Tests', () => {
    describe('Giftcard Management Component', () => {
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(GiftcardComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.giftcards[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
